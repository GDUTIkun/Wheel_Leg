...
- 当前腿部世界角约定为右侧水平轴 `0 deg`、顺时针为正、竖直向下 `90 deg`、竖直向上 `270 deg`；髋关节和膝关节的角度、角速度均已按 `leg_angle_mapping.md` 加入安装偏置与极性映射，其中四个关节角速度极性和 knee 叠加 hip 角速度已于 2026-06-25 实机确认。
